...
QT_MOC_LITERAL(3, 22, 10) // "StartTimer"
    ...
    "WorkerCCD\0sendingImg\0\0StartTimer"
};
...
void WorkerCCD::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendingImg((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        ...
        {
            typedef void (WorkerCCD::*_t)(QImage );
...
// SIGNAL 0
void WorkerCCD::sendingImg(QImage _t1)
{
